...
class Gblast extends StatelessWidget {
  const Gblast({Key? key}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      'Pada daun terdapat becak coklat berbentuk belah ketupat dan memanjang searah dengan urat daun. \n Pinggir becak berwarna coklat dengan bagian tengah berwarna putih keabuan. \n3. Bercak-bercak terutama terlihat pada stadium pertumbuhan vegetative. \n4. Bercak-bercak dapat bergabung menjadi satu, sehingga secara keseluruhan tampak tanaman seperti terbakar.',
                      style: blackStyle.copyWith(
                        fontSize: 18,
